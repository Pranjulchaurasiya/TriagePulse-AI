...
POSITIVE_EMERGENCY_CASES = [
    ...
    "My mother cannot speak suddenly",
    "She has sudden weakness in her right hand",
    "I have sudden numbness on one side of my body",
    "I can't move my arm this morning",
    "He suffered sudden paralysis in his leg",
    "I think my grandmother is having a stroke",
    "My son is having a seizure on the floor",
    "He is fitting violently right now",
    "The patient is convulsing",
    # Hemorrhage / Trauma
    "I am coughing up blood and feeling faint",
    "Coughing blood into a tissue",
    "My sister is vomiting blood",
    "He is throwing up blood repeatedly",
    "There is severe bleeding from a deep wound",
    "She is bleeding profusely from her arm",
    "Blood spurting out from a cut",
    "The bleeding won't stop despite applying pressure",
    "The wound is bleeding will not stop",
    "A man was stabbed outside the building",
    "Someone suffered a gunshot wound",
    "There is an arterial bleed after an accident",
    # Collapse / Unresponsive
    "My father just passed out on the stairs",
    "A woman collapsed in the reception queue",
    "He is completely unconscious and won't answer",
    "She is lying unresponsive on the bed",
    "My brother is not waking up this morning",
    "He won't wake up no matter what I do",
    "I blacked out twice while standing up",
    "Patient had a sudden loss of consciousness",
    # Anaphylaxis
    "I am having an anaphylaxis reaction to bee sting",
    "Going into anaphylactic shock right now",
